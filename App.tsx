        ...
        <section id="vision" className="py-32 px-6 lg:px-12 max-w-7xl mx-auto relative scroll-mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <FeatureCard
              ...
              description="Launched as a CTO with zero team tokens. Fair launch, pure community power. This is the art of bagworking—relentless like the eagle."
              tag="CTO"
            />
            <FeatureCard
            ...
            <FeatureCard
              ...
              title="Solana Speed"
              description="Built on the fastest blockchain with 0% taxes. Lightning-fast swaps, locked liquidity, and the WLFI ecosystem behind us."
              tag="SOLANA"
            />
          </div>
        </section>
